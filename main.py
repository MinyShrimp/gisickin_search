...
class MainForm():
    ...
    def __start_thread(self):
        _tmp = [ _[1] for _ in DataBase.select_keyword_all() ]
        _tmp_date = self.ui.date.date()
        self.web_crawling = Crawling( _tmp, self.ui.pg_intellectual_start.value(), self.ui.pg_intellectual_end.value(), date( _tmp_date.year(), _tmp_date.month(), _tmp_date.day() ), self.__init_tb_search_items )
